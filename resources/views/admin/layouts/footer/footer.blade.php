<div class="footer__modal mobile">
	...
	<footer class="footer_mobile mobile">
		...
		<a href="#" class="footer__company">Разработка сайтов ООО «Агаев Диджитал»</a>
		<div class="footer__bar">
			<a href="" class="footer__link">
				<img src="img/mobile/home.svg" alt="" class="footer__icon">
			</a>
			<a href="author" class="footer__link">
		...
		<div class="container">
			<div class="footer__content">
				<div class="footer__top">
					...
					<div class="footer__phone">+7 977 717 84 87</div>
				</div>
				<div class="footer__bottom">
					<div class="footer__company-name">
						© 2020 - ООО  «Агаев Диджитал»
					</div>
					<a href="https://agaev.digital/" target="_blank" class="footer__company-logo">
